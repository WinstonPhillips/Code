...
public final class AVLTree extends BinarySearchTree implements Execute // implements execute interface 
{
   ...
   public void execute(Command command)
   {
      ...
      {
         command.execute(object); // the execute method that is implemented from the Command interface
      }
   }
}
